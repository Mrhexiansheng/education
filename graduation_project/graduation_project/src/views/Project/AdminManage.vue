                                ...
                                >
                                    ...
                                    <el-table-column
                                        ...
                                        <template slot-scope="experts_type">
                                            <el-button type="text" v-if="experts_type.row.experts_type === 1">
                                                教学综合改革类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 2">专业建设类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 3">
                                                人才培养改革类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 4">实践教学类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 5">创新创业类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 6">教学管理类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 7">
                                                师资队伍建设类专家
                                            </el-button>
                                            <el-button type="text" v-if="experts_type.row.experts_type === 8">
                                                新工科研究与实践类专家
                                            </el-button>
                                        </template>
                                    </el-table-column>
            ...
            <el-tab-pane label="项目审核" name="second">
                ...
                >
                    ...
                    <el-table-column
                            ...
                            width="120">
                        <template slot-scope="cz">
                            <el-button type="text" @click="audit(cz.row.id,cz.row.name)">审核</el-button>
                            <el-dialog
                                    title="项目审核"

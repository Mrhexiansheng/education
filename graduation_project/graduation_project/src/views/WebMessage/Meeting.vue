<template>
    <el-container>
        ...
        <el-main>
            <div class="firstBox">
                <div class="news">
                    <router-link :to="{path:'/allNews',query:{types:'xjhy'}}" tag="div" class="more">查看更多</router-link>
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="校级会议信息" name="first">
                            <el-row  justify="space-around" type="flex">
                ...
                <div class="notice">
                    <router-link :to="{path:'/allNews',query:{types:'yjhy'}}" tag="div" class="more">查看更多</router-link>
                    <el-tabs v-model="activeName1" @tab-click="handleClick1">
                        <el-tab-pane label="院级会议信息" name="first">
                            <el-row justify="space-around" type="flex">

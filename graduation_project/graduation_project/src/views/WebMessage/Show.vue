...
<!--            <swiper-slide>
                <router-link :to="{name: 'content',query:{id:data2[0].id,types:data2[0].logo}}" style="z-index: 2000">
                    <img :src="data2[0].thumb ? data2[0].thumb[0].url:require('../../assets/5.png')" alt=""
                         class="thumb" style="display: block;width: 100%;height: 100%">
                </router-link>
            </swiper-slide>
            <swiper-slide>
                <router-link :to="{name: 'content',query:{id:data4[0].id,types:data4[0].logo}}" style="z-index: 2000">
                    <img :src="data4[0].thumb ? data4[0].thumb[0].url:require('../../assets/5.png')" alt=""
                         class="thumb" style="display: block;width: 100%;height: 100%">
                </router-link>
            </swiper-slide>
            <swiper-slide>
                <router-link :to="{name: 'content',query:{id:data6[0].id,types:data6[0].logo}}" style="z-index: 2000">
                    <img :src="data6[0].thumb ? data6[0].thumb[0].url:require('../../assets/5.png')" alt=""
                         class="thumb" style="display: block;width: 100%;height: 100%">
                </router-link>
            </swiper-slide>
            <swiper-slide>
                <router-link :to="{name: 'content',query:{id:data8[0].id,types:data8[0].logo}}" style="z-index: 2000">
                    <img :src="data8[0].thumb ? data8[0].thumb[0].url:require('../../assets/5.png')" alt=""
                         class="thumb" style="display: block;width: 100%;height: 100%">
                </router-link>
            </swiper-slide>-->  <swiper-slide><img src="../../assets/1.jpg" alt=""></swiper-slide>
            ...
            <div class="firstBox">
                <div class="news">
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="新闻资讯" name="first">
                            <el-row justify="space-around" type="flex">
                                <el-col :span="11" class="col" v-for="item in data2">
                                    <el-row>
                                        <router-link :to="{name: 'content',query:{id:item.id,types:item.logo}}"
                                                     style="z-index: 2000"><img
                                                :src="item.thumb ? item.thumb[0].url:require('../../assets/5.png')"
                                                alt="" class="thumb"></router-link>
                                    </el-row>
                                    <el-row justify="space-around" type="flex">
                                        <el-col :span="18">
                                            <el-popover
                        ...
                        <el-tab-pane label="校内资讯" name="second">
                            <el-row justify="space-around" type="flex">
                                ...
                                <el-col :span="12" class="col">
                                    <el-row justify="space-around" type="flex" class="li" v-for="item in data3">
                                        <el-col :span="15"
                ...
                <div class="notice">
                    <el-tabs v-model="activeName1" @tab-click="handleClick1">
                        <el-tab-pane label="通知信息" name="first">
                            <el-row justify="space-around" type="flex">
                                <el-col :span="11" class="col" v-for="item in data6">
                                    <el-row>
                                        <router-link :to="{name: 'content',query:{id:item.id,types:item.logo}}"
                                                     style="z-index: 2000"><img
                                                :src="item.thumb ? item.thumb[0].url:require('../../assets/5.png')"
                                ...
                                <el-col :span="12" class="col">
                                    <el-row justify="space-around" type="flex" class="li" v-for="item in data5">
                                        <el-col :span="15"
                                                style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                            <el-popover
                                                    placement="top-start"
                        ...
                        <el-tab-pane label="会议信息" name="second">
                            <el-row justify="space-around" type="flex">
                                <el-col :span="11" class="col" v-for="item in data8">
                                    <el-row>
                                        <router-link :to="{name: 'content',query:{id:item.id,types:item.logo}}"
                                                     style="z-index: 2000"><img
                                                :src="item.thumb ? item.thumb[0].url:require('../../assets/5.png')"
                                ...
                                <el-col :span="12" class="col">
                                    <el-row justify="space-around" type="flex" class="li" v-for="item in data7">
                                        <el-col :span="15"
                                                style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                            <el-popover
                                                    placement="top-start"
            ...
            getData() {
                this.$axios.get(this.$api.SCHOOLNEWS, {
                    ...
                    if (res.data.code === 200) {
                        ...
                        res.data.data5.forEach(function (value, index) {
                            if (value.file) {
                                value.file = JSON.parse(value.file)
                            }
                            if (value.thumb) {
                        ...
                        res.data.data6.forEach(function (value, index) {
                            if (value.file) {
                                value.file = JSON.parse(value.file)
                            }
                            if (value.thumb) {
                        ...
                        res.data.data7.forEach(function (value, index) {
                            if (value.file) {
                                value.file = JSON.parse(value.file)
                            }
                            if (value.thumb) {
                        ...
                        res.data.data8.forEach(function (value, index) {
                            if (value.file) {
                                value.file = JSON.parse(value.file)
                            }
                            if (value.thumb) {

<template>
    <el-container>
        ...
        <el-main>
            <div class="firstBox">
                <div class="news">
                    <router-link :to="{path:'/allNews',query:{types:'xj'}}" tag="div" class="more">查看更多</router-link>
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="校级资讯" name="first">
                            <el-row  justify="space-around" type="flex">
                ...
                <div class="notice">
                    <router-link :to="{name:'allNews',query:{types:'yj'}}" tag="span" class="more1">查看更多</router-link>
                    <el-tabs v-model="activeName1" @tab-click="handleClick1">
                        <el-tab-pane label="院级资讯" name="first">
                            <el-row justify="space-around" type="flex">

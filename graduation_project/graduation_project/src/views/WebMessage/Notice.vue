<template>
    <el-container>
        ...
        <el-main>
            <div class="firstBox">
                <div class="news">
                    <router-link :to="{path:'/allNews',query:{types:'lx'}}" tag="div" class="more">查看更多</router-link>
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="立项通知" name="first">
                            <el-row  justify="space-around" type="flex">
                ...
                <div class="notice">
                    <router-link :to="{path:'/allNews',query:{types:'sh'}}" tag="div" class="more">查看更多</router-link>
                    <el-tabs v-model="activeName1" @tab-click="handleClick1">
                        <el-tab-pane label="审核通知" name="first">
                            <el-row justify="space-around" type="flex">

<template>
    <div>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="校内资讯信息" name="first">
                <el-row>
                    <el-col :span="24">
                        <el-table
                                :data="tableData"
                        ...
                        >
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="abroad">
                                    <el-button type="text" v-if="abroad.row.abroad === 1">校级</el-button>
                                    <el-button type="text" v-if="abroad.row.abroad === 2">院级</el-button>
                                </template>
                            </el-table-column>
                            <el-table-column
                                    prop="college"
...
<!--                                    <el-button type="text" @click="edit(cz.row.id)">编辑</el-button>-->
                                            ...
                                            <el-col>
                                                <el-form label-width="120px" :model="editForm" ref="editForm">
                                                    <el-form-item label="资讯类别" prop="abroad">
                                                        <el-radio v-model="editForm.abroad" label="1">校级</el-radio>
                                                        <el-radio v-model="editForm.abroad" label="2">院级</el-radio>
                                                    </el-form-item>
                                                    <el-form-item label="所属学院" prop="college" v-if="editForm.abroad == 2">
                                                        <el-select v-model="editForm.college" placeholder="请选择所属学院">
                                                            <el-option
                                                    ...
                                                    <el-form-item label="资讯简介" prop="description">
                                                        <el-input placeholder="请输入资讯简介" v-model="editForm.description" type="textarea"
                                                                  :rows="2"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="资讯内容" prop="content">
                                                        <el-input placeholder="请输入资讯简介" v-model="editForm.content" type="textarea"
                                                                  :rows="2"></el-input>
                                                    </el-form-item>
            ...
            <el-tab-pane label="校内资讯信息添加" name="second">
                <el-row>
                    <el-col :span="10">
                        <el-form :model="form" status-icon :rules="rules" ref="ruleForm" label-width="120px"
                            ...
                            <el-form-item label="资讯类别" prop="abroad">
                                <el-radio v-model="form.abroad" label="1">校级</el-radio>
                                <el-radio v-model="form.abroad" label="2">院级</el-radio>
                            </el-form-item>
                            <el-form-item label="所属学院" prop="college" v-if="form.abroad == 2">
        ...
        methods: {
                ...
                this.$refs.ruleForm.validate((val) => {
                    if (val) {
                        this.$confirm('是否选择添加该资讯?', '提示', {
                            ...
                            this.$axios.post(this.$api.SCHOOLNEWS, this.form).then(res => {
                                if (res.data.code === 200) {
                    ...
                    if (column.property == "title") {
                        ...
                        input.onblur = function () {
                            ...
                            if (input.value != row.title) {
                                ...
                                _this.$axios.put(_this.$api.SCHOOLNEWS, {
                                    type: "title",
                                    title: row.title,
                                    id: row.id
                                }).then(res => {
            ...
            del(id) {
                this.$confirm('是否选择删除该信息?', '提示', {
                    ...
                    this.$axios.delete(this.$api.SCHOOLNEWS, {id}).then(res => {
                        if (res.data.code === 200) {
                            this.$message.success(res.data.msg);
                            this.getData();
                        } else {

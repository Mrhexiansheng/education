<template>
    <div>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="会议信息添加" name="second">
                <el-row>
                    <el-col :span="10">
                        <el-form :model="form" status-icon :rules="rules" ref="ruleForm" label-width="120px"
                            ...
                            <el-form-item label="会议类别" prop="abroad">
                            ...
                            <el-form-item label="信息图片" prop="thumb">
                                <el-upload
                                        class="upload-demo"
                                        :action="upload"
                            ...
                            <el-form-item label="信息附属文件" prop="file">
                                <el-upload
                                        class="upload-demo"
                                        :action="uploadFile"
        ...
        methods: {
                ...
                this.$refs.ruleForm.validate((val) => {
                    if (val) {
                        this.$confirm('是否选择添加该资讯?', '提示', {
                            ...
                            this.$axios.post(this.$api.MEETING, this.form).then(res => {
                                if (res.data.code === 200) {
                    ...
                    if (column.property == "title") {
                        ...
                        input.onblur = function () {
                            ...
                            if (input.value != row.title) {
                                ...
                                _this.$axios.put(_this.$api.MEETING, {
                                    type: "title",
                                    title: row.title,
                                    id: row.id
                                }).then(res => {
            ...
            del(id) {
                this.$confirm('是否选择删除该信息?', '提示', {
                    ...
                    this.$axios.delete(this.$api.MEETING, {id}).then(res => {
                        if (res.data.code === 200) {
                            this.$message.success(res.data.msg);
                            this.getData();
                        } else {
